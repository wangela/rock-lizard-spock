...
public class FacebookClient extends OAuthBaseClient {
    ...
    public static final String REST_URL = "https://www.facebook.com/dialog/oauth?client_id=%s&redirect_uri=%s";
    ...
    public static final String REST_CALLBACK_URL = "oauth://changedbydesign.com";
